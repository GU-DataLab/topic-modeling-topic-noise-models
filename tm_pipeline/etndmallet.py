...
# Edited to run NFT and save noise distribution by Rob Churchill (Feb 2021)
...
class eTndMallet(utils.SaveLoad, basemodel.BaseTopicModel):
    ...
    def load(cls, *args, **kwargs):
        ...
        """
        model = super(eTndMallet, cls).load(*args, **kwargs)
