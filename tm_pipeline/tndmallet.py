...
# Edited to run TND and save noise distribution by Rob Churchill (Feb 2021)
...
class TndMallet(utils.SaveLoad, basemodel.BaseTopicModel):
    ...
    def load(cls, *args, **kwargs):
        ...
        """
        model = super(TndMallet, cls).load(*args, **kwargs)
