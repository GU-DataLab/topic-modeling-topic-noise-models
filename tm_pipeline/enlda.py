...
class ENLDA:
    ...
    def __init__(self, dataset=None, tnd_k=30, tnd_alpha=50, tnd_beta0=0.01, tnd_beta1=25, tnd_noise_words_max=200,
                 ...
                 closest_x_words=3, random_seed=1824, run=True):
    ...
    def compute_tnd(self):
        ...
        :return: void
        """
        model = eTndMallet(self.mallet_tnd_path, self.corpus, num_topics=self.tnd_k, id2word=self.dictionary, workers=4,
                          ...
                          random_seed=self.random_seed, closest_x_words=self.closest_x_words, embedding_path=self.embedding_path)
