...
public class CopyCallable implements Callable<String> {
    ...
    public CopyCallable(WorkerCallable targetCallable, int[][] typeTopicCounts, int[] tokensPerTopic, HashMap<String, List<String>> optCloseWords) {
    ...
    public String call() throws Exception {
        ...
        targetCallable.optCloseWords = optCloseWords;
